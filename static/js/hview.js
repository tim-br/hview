document.addEventListener("DOMContentLoaded", function() {
    ...
    function resetListeners() {
      ...
      parents.forEach(parent => {
          ...
          const targetIdValue = parent.getAttribute('target-id') || null;
          ...
          if (parent.hasAttribute('h-click')) {
            children = [parent].concat(children); // Include the parent if it has 'h-click'
          }          
          ...
          children.forEach(child => {
              ...
              child.addEventListener('click', function() {
                  ...
                  const dataToSend = { hID: hIdValue, targetID: targetIdValue, dispatch: hClickValue, payload: hValue.toString() };
